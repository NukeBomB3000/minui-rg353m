// rg353m (RK3566, 640x480, dArkOS/KMS)
...
// All buttons handled via raw evdev in platform.c
...
// JOY_* = SDL joystick button indices (BTN_GAMEPAD base = 304)
#define JOY_UP			13
#define JOY_DOWN		14
#define JOY_LEFT		15
#define JOY_RIGHT		16
